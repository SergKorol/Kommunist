...
namespace Kommunist.Application.ViewModels
{
    public class PlaygroundViewModel : BaseViewModel
    {
        ...
        public Color CalendarBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundColor"];
        public Color NavigationBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryColor"];
        public Color NavigationTextColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryTextColor"];
        public Color NavigationArrowColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryTextColor"];
        public Color NavigationArrowBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryColor"];
        public Color DayCurrentMonthBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundColor"];
        public Color DayCurrentMonthTextColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundTextColor"];
        public Color DayOtherMonthBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundColor"];
        public Color DayOtherMonthTextColor { get; set; } = Color.FromArgb("#FFA0A0A0");
        public Color DayTodayBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundColor"];
        public Color DayTodayTextColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryColor"];
        public Color DaySelectedBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryColor"];
        public Color DaySelectedTextColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarPrimaryTextColor"];
        public Color DayInvalidBackgroundColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarBackgroundColor"];
        public Color DayInvalidTextColor { get; set; } = (Color)Microsoft.Maui.Controls.Application.Current.Resources["CalendarTertiaryColor"];
        #endregion
        ...
        public void NavigateCalendar(int amount)
        {
            ...
            switch (NavigationTimeUnit)
            {
                ...
                default:
                    throw new Exception($"{nameof(NavigationTimeUnit)} '{NavigationTimeUnit}' is not implemented.");
            }
